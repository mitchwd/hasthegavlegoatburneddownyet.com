...
describe('footer', () => {
  it('shows a link to the developer', async () => {
    render(<Footer />);
    ...
    await expect
      .element(link)
      .toHaveAttribute('href', 'https://www.mitchwd.com');
  });

  it('shows a link to the image credit', async () => {
    render(<Footer />);
  ...
  it('shows exactly 2 links', async () => {
    render(<Footer />);
