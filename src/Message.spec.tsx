...
describe('message', () => {
  it('shows the prompt and answer', async () => {
    render(<Message />);
  ...
  describe('before season', () => {
    ...
    it('shows an out of season message with no fallen date set', async () => {
      render(<Message />);
    ...
    it('shows an out of season message with past fallen date set', async () => {
  ...
  describe('during season', () => {
    ...
    it('shows a standing message when no fallen date', async () => {
      render(<Message />);
    ...
    it('shows a standing message when fallen date is last season', async () => {
      // Set fallenString to last season
      render(<Message fallenString='2024-12-25T00:00:00.000Z' />);
    ...
    it('shows a fallen message when fallen date is within season', async () => {
